...
if __name__ == "__main__":
    ...
    if 1:
        from uvscada.gxs700 import GXS700
        gxs = GXS700(usbcontext=usbcontext, dev=dev, verbose=False, init=False)
        gxs.flash_w(0xFF00, 'omgbbq!')
    ...
    if 0:
        ...
        if 0:
            ...
            print
            print
            hexdump(read1(dev, 0x000, 0x80))
            #read2(dev, 0x000, 0x10)
