...
def main(dev):
    ...
    buff = controlRead(0xA3, 0x00, 0x0000, 0x0003, 4)
    validate_read("\x03\x05\x10\x00", buff, "packet 31/32")
    time.sleep(0.056)
    ...
    # NOTE:: req max 64 but got 18
    validate_read("\x12\x01\x00\x02\xFF\xFF\xFF\x40\xB9\x14\x01\x00\x00\x00\x01\x02"
              "\x00\x01", buff, "packet 35/36")
    # Generated from packet 37/38
    controlWrite(0x23, 0x03, 0x0004, 0x0003, "")
    time.sleep(0.056)
    # Generated from packet 39/40
    buff = controlRead(0xA3, 0x00, 0x0000, 0x0003, 4)
    validate_read("\x03\x05\x10\x00", buff, "packet 39/40")
    time.sleep(0.056)
    ...
    buff = controlRead(0xA3, 0x00, 0x0000, 0x0003, 4)
    validate_read("\x03\x05\x10\x00", buff, "packet 75/76")
    time.sleep(0.056)
    ...
    # NOTE:: req max 64 but got 18
    validate_read("\x12\x01\x00\x02\xFF\xFF\xFF\x40\xB9\x14\x01\x00\x00\x00\x01\x02"
              "\x00\x01", buff, "packet 79/80")
    # Generated from packet 81/82
    controlWrite(0x23, 0x03, 0x0004, 0x0003, "")
    time.sleep(0.056)
    # Generated from packet 83/84
    buff = controlRead(0xA3, 0x00, 0x0000, 0x0003, 4)
    validate_read("\x03\x05\x10\x00", buff, "packet 83/84")
    time.sleep(0.056)
    ...
    buff = controlRead(0xA3, 0x00, 0x0000, 0x0003, 4)
    validate_read("\x03\x05\x10\x00", buff, "packet 99/100")
    time.sleep(0.056)
    ...
    # NOTE:: req max 64 but got 18
    validate_read("\x12\x01\x00\x02\xFF\xFF\xFF\x40\xB9\x14\x01\x00\x00\x00\x01\x02"
              "\x00\x01", buff, "packet 103/104")
    # Generated from packet 105/106
    controlWrite(0x23, 0x03, 0x0004, 0x0003, "")
    time.sleep(0.056)
    # Generated from packet 107/108
    buff = controlRead(0xA3, 0x00, 0x0000, 0x0003, 4)
    validate_read("\x03\x05\x10\x00", buff, "packet 107/108")
    time.sleep(0.056)
