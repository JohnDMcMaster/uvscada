...
def main(dev):
    dev.controlWrite(0x02, 0x01, 0x0000, 0x0086, "")
    dev.controlWrite(0x02, 0x01, 0x0000, 0x0002, "")
    dev.controlWrite(0x40, 0xA0, 0xE600, 0x0000, "\x01")
    dev.controlWrite(0x40, 0xA0, 0x0000, 0x0000, "\x02\x07\x52\x02\x0F\xE3\x20\x81\x06\x12\x0F\x88\x7F\x01\x22\x7F"
    ...
    dev.controlWrite(0x40, 0xA0, 0x03FF, 0x0000, "\x44\x20\xF0\x80\x45\xE5\x30\x24\xFE\xB5\x34\x07\x90\xE6\x78\xE0"
    ...
    dev.controlWrite(0x40, 0xA0, 0x07FE, 0x0000, "\x90\xE6\xC1\xF0\x90\x1C\x83\xE0\x90\xE6\xC2\xF0\x90\x1C\x85\xE0"
    ...
    dev.controlWrite(0x40, 0xA0, 0x0BFD, 0x0000, "\x1D\x85\x2A\x28\x85\x2B\x29\x12\x00\x28\x12\x00\x16\x74\x20\xF0"
    ...
    dev.controlWrite(0x02, 0x01, 0x0000, 0x0086, "")
    dev.controlWrite(0x02, 0x01, 0x0000, 0x0002, "")
    dev.controlWrite(0x02, 0x01, 0x0000, 0x0088, "")
    buff = dev.controlRead(0xC0, 0xB0, 0x0000, 0x0000, 4096)
